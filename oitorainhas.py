...
def individuo():
    ...
    for i in range(tamanho_individuo):
        individuo.append(str(random.getrandbits(1)))
...
def recombinacao(pais):
    ...
    if(random.random() <= probabilidade_recombinacao):
        ...
        #print("pais:", parent)
        filhos[0][:point] = parent[0][:point]
        filhos[1][:point] = parent[1][:point]
        cont_filho0 = point - 1
        cont_filho1 = point - 1
        for i in range(point, 8):
            ...
            #print(filhos)
        #print("cont filho0:", cont_filho0)
        #print("cont filho1:", cont_filho1)
...
#for i in range(100):
#    a.append(individuo())
#scored = [(fitness(i), i) for i in a]
#print(scored)
#print(selecaoRoleta(a))
...
for k in range(30):
    ...
    for i in range(10000):
        ...
        filhos_criados = recombinacao(pais_selecionados)
